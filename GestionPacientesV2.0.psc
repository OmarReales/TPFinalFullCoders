    ...
    Repetir
        ...
        Segun opcionMenu
			...
			Si cantPacientes > 0 Entonces
				...
				Para i <- 1 Hasta cantPacientes 
					Mostrar i , ". ", pacientes[i]
				Fin Para
			...
			Si numPaciente >= 1 Y numPaciente < cantPacientes Entonces
				...
				Para i <- numPaciente Hasta cantPacientes - 1
		...
		Fin Si
			...
			// Mostrar lista de pacientes
				Si cantPacientes > 0 Entonces
					Mostrar "Lista de pacientes:"
				Para i <- 1 Hasta cantPacientes 
					Mostrar i , ". ", "Nombre: ", pacientes[i], " - Historia Clínica: ", historiasClinicas[i], " - Obra Social: ", obrasSociales[i]
				Fin Para
		SiNo
